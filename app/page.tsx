      ...
      <section className="pt-32 pb-20 px-6 max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-12">
        <div className="flex-1 text-center lg:text-left">
          ...
          <p className="text-lg text-slate-500 mb-8 max-w-xl mx-auto lg:mx-0">
            TREGO connecte vos cartes, flyers et bracelets a internet via NFC. Modifiez votre contenu a distance, en temps reel, sans toucher a lobjet.
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              { icon: "📄", title: "Flyers NFC", text: "Au meme prix qu un flyer classique mais connecte. Modifiez le contenu apres impression.", tag: "Evenements et Salons", href: "/products" },
