        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="bg-blue-600 rounded-2xl p-10 text-white">
            ...
            <p className="text-blue-100 mb-8">
              On vous présente TREGO en 20 minutes, on répond à toutes vos questions et on vous propose la solution adaptée à votre besoin.
            </p>
          ...
          <div className="bg-slate-50 rounded-2xl p-10">
            <h2 className="text-2xl font-bold text-slate-900 mb-8">✉️ Nous écrire</h2>
            <form className="space-y-6">
              ...
              <div>
                ...
                <textarea rows={4} className="w-full border border-slate-200 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-600 resize-none" placeholder="Décrivez votre projet ou votre besoin..." />
              </div>
